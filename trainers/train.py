...
class Trainer(AbstractTrainer):
   ...
   This class contain the main training functions for our UPR-BP
    ...
    def __init__(self, args):
        ...
        self.results_columns = ["sbp", "dbp", "map", "run", 'me', 'sde', 'mae']
    ...
    def test(self):
        ...
        last_scenario_mean_std = last_results.groupby('scenario')[['me', 'sde', 'mae']].agg(['mean', 'std'])
        best_scenario_mean_std = best_results.groupby('scenario')[['me', 'sde', 'mae']].agg(['mean', 'std'])
